---
title: 'Lab 3 Assignment: Google Location History'
...
Register for google maps API (see above), change zoom and successfully load this code:

**Swap `eval=FALSE` to `eval=TRUE` once after getting your google api key**
...
sz<-get_googlemap(center = c(lon = -3.703790, lat = 40.416775)
              , zoom = 10
              , maptype="roadmap"
              , scale = 2
              , color = "bw") 
...
Zoom in cloass enough to read neighborhood names.
...
Repeat the analysis below, but for your own data:
