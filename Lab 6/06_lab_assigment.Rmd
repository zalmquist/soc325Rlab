...
We will use the `read_xlsx([URL TO SHEET HERE])` to get the sheet information. 
...
Step 2, let's plot `heart_rate` by `walking_duration` with best fit line (linear model)
